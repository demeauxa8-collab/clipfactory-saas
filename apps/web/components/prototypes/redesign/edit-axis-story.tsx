...
function PricingSection({ startHref }: { startHref: Route }) {
  return (
    <section
      id="pricing"
    ...
    >
      <div className={styles.pricingIntro}>
        <Reveal>
          <p>One plan. The whole workflow.</p>
          <h2 id="pricing-title-v6">Start with the source you already have.</h2>
        </Reveal>
        <Reveal delay={0.08}>
          <p>
            No artificial feature maze. Starter covers the path from source URL
            to finished vertical clips.
          </p>
        </Reveal>
      </div>

      <Reveal className={styles.priceLedger}>
